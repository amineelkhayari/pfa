...
# smartConfirm user via gosu so the Node process never holds root privileges.
set -e

mkdir -p /app/data/baileys /app/data/media /app/data/plugins
chown -R smartConfirm:smartConfirm /app/data
