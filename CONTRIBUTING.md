# Contributing to SmartConfirm

Thanks for your interest in improving SmartConfirm! This guide covers how to get set up, the
...
SmartConfirm is a NestJS (backend) + React/Vite (dashboard) project:
...
SmartConfirm targets **Node.js 22+**.
...
questions rather than defects in SmartConfirm. Routing them correctly upfront saves everyone
