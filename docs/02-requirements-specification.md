...
This document defines the functional and non-functional requirements for SmartConfirm.
...
sequenceDiagram
    actor User
    participant API as SmartConfirm API
...
sequenceDiagram
    participant WA as WhatsApp
    participant Engine as WA Engine
    participant API as SmartConfirm
