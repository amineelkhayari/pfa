...
### GHCR
GitHub Container Registry - registry for storing Docker images. The SmartConfirm image is available at `ghcr.io/rmyndharis/smartConfirm` (and, mirrored per release, at `docker.io/rmyndharis/smartConfirm`).
